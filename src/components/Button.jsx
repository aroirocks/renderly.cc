...
const variantStyles = {
  solid: {
    ...
    white:
      'bg-white text-slate-900 hover:bg-slate-50 active:bg-slate-100 active:text-slate-600 focus-visible:outline-white',
    red: 'bg-red-500 text-white hover:bg-red-600 active:bg-red-700 focus-visible:outline-red-500',
  },
  outline: {
    slate:
