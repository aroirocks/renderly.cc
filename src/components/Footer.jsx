      ...
      <Container>
        ...
        <div className="flex flex-col items-center border-t border-slate-400/10 py-10 sm:flex-row-reverse sm:justify-between">
          <div className="flex items-center gap-x-6">
            {/* <Link
              href="https://x.com/renderlycc"
              className="group"
              aria-label="Renderly on X"
            >
              <svg
            ...
            <Link
              href="mailto:support@renderly.cc"
              className="text-sm text-slate-500 hover:text-slate-700"
              aria-label="Contact Renderly support"
            >
              support@renderly.cc
            </Link>
          </div>
          ...
          <p className="mt-6 text-sm text-slate-500 sm:mt-0">
            Copyright &copy; {new Date().getFullYear()} Renderly. All rights reserved.
          </p>
        </div>
      </Container>
    </footer>
